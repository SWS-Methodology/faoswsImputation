...
\hlstd{imputationParams}\hlopt{$}\hlstd{plotImputation} \hlkwb{=} \hlstr{"faceted"}
...
\hlstd{imputationParameters}\hlopt{$}\hlstd{plotImputation} \hlkwb{=} \hlstr{"faceted"}
...
\hlkwd{invisible}\hlstd{(exampleData[timePointYears} \hlopt{%in%} \hlnum{2005}\hlopt{:}\hlnum{2007} \hlopt{&}
